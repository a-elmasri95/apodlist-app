Using the flutter SDK, this simple app retrieves images and metadata from the NASA APOD API https://api.nasa.gov/ using REST API, and displays them in a listView.
